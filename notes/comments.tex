...
\item \sout{This statement isn’t exactly true: “Identification of these conditions is common in modular robot reconfiguration planning [3] and motion planning [13].”  I know of only Casal's work that explicitly looked at self-collision and stability under gravity.  Self-collision is really only an issue for chain based systems as it’s easy to detect with lattice.
}\item “\sout{While this is a constraint, the majority of functional designs for chain-architecture modular robots are acyclic, so we feel that it does not unreasonably limit the utility of our framework. TODO: Mark, should we cite something here? .”
