...
We present a small library of configurations in Tables \ref{tier-1-configurations}
and \ref{tier-2-configurations}.
\begin{table*}
    \begin{center}
        \includegraphics[width=\textwidth]{images/library/tier1.pdf}
        \caption{Tier-1 configurations (basic configurations)}
        \label{tier-1-configurations}
    \end{center}
\end{table*}
\begin{table*}
    \begin{center}
